...
function AntiCrash.ServerCrash()
	...
	local retrytime = menucrashtime + 25
	...
	--dbutton:SetText("Check out our other Servers")
	--dbutton.DoClick = function()
	--	SendLua([[gui.OpenURL("http://icemodservers.de/banlist/index.php?p=srv")]]) -- Change ADDRESS to your chosen page.
--
	--end
